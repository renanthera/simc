...
// #include "class_modules/monk/sc_monk.cpp"
...
void brewmaster( player_t *p )
{
  ...
  // ); rotation_boc->add_action( "purifying_brew,if=(!buff.blackout_combo.up)" ); rotation_boc->add_action(
  // "rising_sun_kick" ); rotation_boc->add_action(
  // "keg_smash,if=buff.weapons_of_order.up&debuff.weapons_of_order_debuff.remains<=gcd*2" ); rotation_boc->add_action(
  // "black_ox_brew,if=energy+energy.regen<=40" ); rotation_boc->add_action(
  // "tiger_palm,if=buff.blackout_combo.up&active_enemies=1" ); rotation_boc->add_action(
  // "breath_of_fire,if=buff.charred_passions.remains<cooldown.blackout_kick.remains" ); rotation_boc->add_action(
  // "keg_smash,if=buff.weapons_of_order.up&debuff.weapons_of_order_debuff.stack<=3" ); rotation_boc->add_action(
  // "summon_white_tiger_statue,if=debuff.weapons_of_order_debuff.stack>3" ); rotation_boc->add_action(
  // "summon_white_tiger_statue,if=!talent.weapons_of_order.enabled" ); rotation_boc->add_action(
  //     "bonedust_brew,if=(time<10&debuff.weapons_of_order_debuff.stack>3)|(time>10&talent.weapons_of_order.enabled)"
  //     );
...
void windwalker( player_t *p )
{
  ...
  //       // name_str -> APL
  //       { "algethar_puzzle_box",
  //         ",use_off_gcd=1,if=(pet.xuen_the_white_tiger.active|!talent.invoke_xuen_the_white_tiger)&!buff.serenity.up|"
  //         "fight_remains<25" },
  //       { "erupting_spear_fragment", ",if=buff.serenity.up|(buff.invokers_delight.up&!talent.serenity)" },
  //       { "manic_grieftorch",
  //         ",use_off_gcd=1,if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&!buff.serenity.up&!pet.xuen_the_white_"
  //         "tiger.active&(debuff.fae_exposure_damage.remains>3|!talent.faeline_harmony)|(trinket.1.has_use_buff|trinket."
  //         "2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>30&cooldown.serenity.remains&(debuff.fae_"
  //         "exposure_damage.remains>2|!talent.faeline_harmony)|fight_remains<5" },
  //       { "beacon_to_the_beyond",
  //         ",use_off_gcd=1,if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&!buff.serenity.up&!pet.xuen_the_white_"
  //         "tiger.active&(debuff.fae_exposure_damage.remains>2|!talent.faeline_harmony)|(trinket.1.has_use_buff|trinket."
  //         "2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>30&cooldown.serenity.remains&(debuff.fae_"
  //         "exposure_damage.remains>2|!talent.faeline_harmony)|fight_remains<10" },
  ...
  //         ",if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&(debuff.fae_exposure_damage.remains|!talent.faeline_"
  //         "harmony)|(trinket.1.has_use_buff|trinket.2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>10&"
  //         "cooldown.serenity.remains&(debuff.fae_exposure_damage.remains|!talent.faeline_harmony)|fight_remains<10"
  //         },
  //       { "irideus_fragment",
  //         ",if=(pet.xuen_the_white_tiger.active|!talent.invoke_xuen_the_white_tiger)&buff.serenity.up|fight_remains<"
  //         "25" },

  //       // Defaults:
  //       { "ITEM_STAT_BUFF",
  //         ",if=(pet.xuen_the_white_tiger.active|!talent.invoke_xuen_the_white_tiger)&buff.serenity.up" },
  //       { "ITEM_DMG_BUFF",
  //         ",if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&(debuff.fae_exposure_damage.remains>5|!talent.faeline_"
  //         "harmony)|(trinket.1.has_use_buff|trinket.2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>30&"
  ...
  //       // name_str -> APL
  //       { "algethar_puzzle_box",
  //         ",use_off_gcd=1,if=(pet.xuen_the_white_tiger.active|!talent.invoke_xuen_the_white_tiger)&!buff.storm_earth_"
  //         "and_fire.up|fight_remains<25" },
  //       { "erupting_spear_fragment", ",if=buff.serenity.up|(buff.invokers_delight.up&!talent.serenity)" },
  //       { "manic_grieftorch",
  //         ",use_off_gcd=1,if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&!buff.storm_earth_and_fire.up&!pet.xuen_"
  //         "the_white_tiger.active&(debuff.fae_exposure_damage.remains>3|!talent.faeline_harmony)|(trinket.1.has_use_"
  //         "buff|trinket.2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>30&(debuff.fae_exposure_damage."
  //         "remains>2|!talent.faeline_harmony)|fight_remains<5" },
  //       { "beacon_to_the_beyond",
  //         ",use_off_gcd=1,if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&!buff.storm_earth_and_fire.up&!pet.xuen_"
  //         "the_white_tiger.active&(debuff.fae_exposure_damage.remains>2|!talent.faeline_harmony)|(trinket.1.has_use_"
  //         "buff|trinket.2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>30&(debuff.fae_exposure_damage."
  //         "remains>2|!talent.faeline_harmony)|fight_remains<10" },
  //       { "djaruun_pillar_of_the_elder_flame",
  //         ",if=cooldown.fists_of_fury.remains<2&cooldown.invoke_xuen_the_white_tiger.remains>10|fight_remains<12" },
  //       { "dragonfire_bomb_dispenser",
  //         ",if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&(debuff.fae_exposure_damage.remains|!talent.faeline_"
  //         "harmony)|(trinket.1.has_use_buff|trinket.2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>10&("
  //         "debuff.fae_exposure_damage.remains|!talent.faeline_harmony)|fight_remains<10" },
  //       { "irideus_fragment",
  ...
  //         ",if=!trinket.1.has_use_buff&!trinket.2.has_use_buff&(debuff.fae_exposure_damage.remains>5|!talent.faeline_"
  //         "harmony)|(trinket.1.has_use_buff|trinket.2.has_use_buff)&cooldown.invoke_xuen_the_white_tiger.remains>30&("
  //         "debuff.fae_exposure_damage.remains>5|!talent.faeline_harmony)" },
  //   };
  ...
  // def->add_action( "spear_hand_strike,if=target.debuff.casting.react" );
  // def->add_action(
  //     "variable,name=hold_xuen,op=set,value=!talent.invoke_xuen_the_white_tiger|cooldown.invoke_xuen_the_white_tiger."
  //     "duration>fight_remains" );
  // def->add_action(
  //     "variable,name=hold_tp_rsk,op=set,value=!debuff.skyreach_exhaustion.remains<1&cooldown.rising_sun_kick.remains<"
  //     "1" );
  ...
  // //                    "Build Chi at the start of combat" );
  // // else
  // //   def->add_action( "call_action_list,name=opener,if=time<4&chi<5&!talent.serenity",
  // //                    "Build Chi at the start of combat" );
  // // Use Trinkets
  // def->add_action( "call_action_list,name=trinkets", "Use Trinkets" );
  // // Prioritize Faeline Stomp if playing with Faeline Harmony
  // def->add_action(
  //     "faeline_stomp,target_if=min:debuff.fae_exposure_damage.remains,if=combo_strike&talent.faeline_harmony&debuff."
  //     "fae_exposure_damage.remains<1",
  //     "Prioritize Faeline Stomp if playing with Faeline Harmony" );
  // // Spend excess energy
  // def->add_action(
  //     "tiger_palm,target_if=min:debuff.mark_of_the_crane.remains+(debuff.skyreach_exhaustion.up*20),if=!buff.serenity."
  //     "up&buff.teachings_of_the_monastery.stack<3&combo_strike&chi.max-chi>=(2+buff.power_strikes.up)&(!talent.invoke_"
  //     "xuen_the_white_tiger&!talent.serenity|((!talent.skyreach&!talent.skytouch)|time>5|pet.xuen_the_white_tiger."
  //     "active))&!variable.hold_tp_rsk",
  //     "TP if not overcapping Chi or TotM" );
  // // Use Chi Burst to reset Faeline Stomp
  // def->add_action(
  //     "chi_burst,if=talent.faeline_stomp&cooldown.faeline_stomp.remains&(chi.max-chi>=1&active_enemies=1|chi.max-chi>="
  //     "2&active_enemies>=2)&!talent.faeline_harmony",
  //     "Use Chi Burst to reset Faeline Stomp" );
  // // Use Cooldowns
  ...
  // // Serenity priority
  // def->add_action( "call_action_list,name=serenity_lust,if=buff.serenity.up&buff.bloodlust.up", "Serenity Priority"
  // ); def->add_action( "call_action_list,name=serenity_aoe,if=buff.serenity.up&active_enemies>4" ); def->add_action(
  // "call_action_list,name=serenity_4t,if=buff.serenity.up&active_enemies=4" ); def->add_action(
  // "call_action_list,name=serenity_3t,if=buff.serenity.up&active_enemies=3" ); def->add_action(
  // "call_action_list,name=serenity_2t,if=buff.serenity.up&active_enemies=2" ); def->add_action(
  ...
  // cd_sef->add_action(
  //     "summon_white_tiger_statue,if=!cooldown.invoke_xuen_the_white_tiger.remains|active_enemies>4|cooldown.invoke_"
  //     "xuen_the_white_tiger.remains>50|fight_remains<=30",
  //     "Storm, Earth and Fire Cooldowns" );
  ...
  //                     " "Tiger</a> is active." );
  // cd_sef->add_action(
  //     "invoke_xuen_the_white_tiger,if=!variable.hold_xuen&target.time_to_die>25&talent.bonedust_brew&cooldown.bonedust_"
  //     "brew.remains<=5&(active_enemies<3&chi>=3|active_enemies>=3&chi>=2)|fight_remains<25" );
  // cd_sef->add_action(
  //     "invoke_xuen_the_white_tiger,if=!variable.hold_xuen&target.time_to_die>25&!talent.bonedust_brew&(cooldown.rising_"
  //     "sun_kick.remains<2)&chi>=3" );
  // cd_sef->add_action(
  //     "storm_earth_and_fire,if=talent.bonedust_brew&(fight_remains<30&cooldown.bonedust_brew.remains<4&chi>=4|buff."
  //     "bonedust_brew.up|!spinning_crane_kick.max&active_enemies>=3&cooldown.bonedust_brew.remains<=2&chi>=2)&(pet.xuen_"
  //     "the_white_tiger.active|cooldown.invoke_xuen_the_white_tiger.remains>cooldown.storm_earth_and_fire.full_recharge_"
  //     "time)" );
  // cd_sef->add_action(
  //     "storm_earth_and_fire,if=!talent.bonedust_brew&(pet.xuen_the_white_tiger.active|target.time_to_die>15&cooldown."
  //     "storm_earth_and_fire.full_recharge_time<cooldown.invoke_xuen_the_white_tiger.remains)" );
  // cd_sef->add_action(
  //     "bonedust_brew,if=(!buff.bonedust_brew.up&buff.storm_earth_and_fire.up&buff.storm_earth_and_fire.remains<11&"
  //     "spinning_crane_kick.max)|(!buff.bonedust_brew.up&fight_remains<30&fight_remains>10&spinning_crane_kick.max&chi>="
  //     "4)|fight_remains<10|(!debuff.skyreach_exhaustion.up&active_enemies>=4&spinning_crane_kick.modifier>=2)|(pet."
  //     "xuen_the_white_tiger.active&spinning_crane_kick.max&active_enemies>=4)" );
  // cd_sef->add_action(
  //     "call_action_list,name=bdb_setup,if=!buff.bonedust_brew.up&talent.bonedust_brew&cooldown.bonedust_brew.remains<="
  //     "2&(fight_remains>60&(cooldown.storm_earth_and_fire.charges>0|cooldown.storm_earth_and_fire.remains>10)&(pet."
  //     "xuen_the_white_tiger.active|cooldown.invoke_xuen_the_white_tiger.remains>10|variable.hold_xuen)|((pet.xuen_the_"
  //     "white_tiger.active|cooldown.invoke_xuen_the_white_tiger.remains>13)&(cooldown.storm_earth_and_fire.charges>0|"
  //     "cooldown.storm_earth_and_fire.remains>13|buff.storm_earth_and_fire.up)))" );
  // cd_sef->add_action(
  //     "storm_earth_and_fire,if=fight_remains<20|(cooldown.storm_earth_and_fire.charges=2&cooldown.invoke_xuen_the_"
  //     "white_tiger.remains>cooldown.storm_earth_and_fire.full_recharge_time)&cooldown.fists_of_fury.remains<=9&chi>=2&"
  //     "cooldown.whirling_dragon_punch.remains<=12" );
  // cd_sef->add_action(
  //     "touch_of_death,target_if=max:target.health,if=fight_style.dungeonroute&!buff.serenity.up&(combo_strike&target."
  //     "health<health)|(buff.hidden_masters_forbidden_touch.remains<2)|(buff.hidden_masters_forbidden_touch.remains>"
  //     "target.time_to_die)" );
  // cd_sef->add_action(
  //     "touch_of_death,cycle_targets=1,if=fight_style.dungeonroute&combo_strike&(target.time_to_die>60|debuff.bonedust_"
  //     "brew_debuff.up|fight_remains<10)" );
  // cd_sef->add_action( "touch_of_death,cycle_targets=1,if=!fight_style.dungeonroute&combo_strike" );

  // // if ( monk->talent.windwalker.invoke_xuen_the_white_tiger->ok() )
  // //   cd_sef->add_action(
  // // "touch_of_karma,target_if=max:target.time_to_die,if=fight_remains>90|pet.xuen_the_white_tiger.active|variable."
  // //       "hold_xuen|fight_remains<16" );
  // // else
  ...
  //                          "Use <a href='https://www.wowhead.com/spell=10060/power-infusion'>Power Infusion</a> while
  //                          "
  //                          "<a href='https://www.wowhead.com/spell=123904/invoke-xuen-the-white-tiger'>Invoke Xuen, "
  //                          "the White Tiger</a> is active." );
  // cd_serenity->add_action(
  //     "invoke_xuen_the_white_tiger,if=!variable.hold_xuen&talent.bonedust_brew&cooldown.bonedust_brew.remains<=5&"
  //     "target.time_to_die>25|buff.bloodlust.up|fight_remains<25" );
  // cd_serenity->add_action(
  //     "invoke_xuen_the_white_tiger,if=target.time_to_die>25&fight_remains>120|fight_remains<60&(debuff.skyreach_"
  //     "exhaustion.remains<2|debuff.skyreach_exhaustion.remains>55)&!cooldown.serenity.remains&active_enemies<3|buff."
  //     "bloodlust.up|fight_remains<23" );
  // cd_serenity->add_action(
  //     "bonedust_brew,if=!buff.bonedust_brew.up&(cooldown.serenity.up|cooldown.serenity.remains>15|fight_remains<30&"
  //     "fight_remains>10)|fight_remains<10" );
  // cd_serenity->add_action(
  //     "serenity,if=buff.invokers_delight.up|variable.hold_xuen&(talent.drinking_horn_cover&fight_remains>110|!talent."
  //     "drinking_horn_cover&fight_remains>105)|!talent.invoke_xuen_the_white_tiger|!talent.invoke_xuen_the_white_tiger|"
  //     "fight_remains<15" );
  // cd_serenity->add_action(
  //     "touch_of_death,target_if=max:target.health,if=fight_style.dungeonroute&!buff.serenity.up&(combo_strike&target."
  //     "health<health)|(buff.hidden_masters_forbidden_touch.remains<2)|(buff.hidden_masters_forbidden_touch.remains>"
  ...
  // cd_serenity->add_action(
  //     "touch_of_death,cycle_targets=1,if=fight_style.dungeonroute&combo_strike&(target.time_to_die>60|debuff.bonedust_"
  //     "brew_debuff.up|fight_remains<10)&!buff.serenity.up" );
  // cd_serenity->add_action(
  ...
  // opener->add_action(
  //     "tiger_palm,target_if=min:debuff.mark_of_the_crane.remains+(debuff.skyreach_exhaustion.up*20),if=combo_strike&"
  //     "chi.max-chi>=(2+buff.power_strikes.up)" );
  ...
  // bdb_setup->add_action(
  //     "tiger_palm,target_if=min:debuff.mark_of_the_crane.remains+(debuff.skyreach_exhaustion.up*20),if=combo_strike&"
  //     "chi.max-chi>=2&buff.storm_earth_and_fire.up" );
  // bdb_setup->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&!talent.whirling_dragon_punch&!spinning_crane_kick.max" );
  // bdb_setup->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=combo_strike&chi>=5&talent.whirling_dragon_punch" );
  // bdb_setup->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=combo_strike&active_enemies>=2&talent.whirling_dragon_punch" );
  ...
  // ); serenity_lust->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&buff.teachings_of_the_monastery.stack=3&buff.teachings_of_the_"
  //     "monastery.remains<1" );
  ...
  // serenity_lust->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&set_bonus.tier30_2pc" );
  ...
  // serenity_lust->add_action(
  //     "tiger_palm,target_if=min:debuff.mark_of_the_crane.remains,if=talent.teachings_of_the_monastery&buff.teachings_"
  //     "of_the_monastery.stack<3" );
  ...
  // serenity_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&!spinning_crane_kick.max&talent.shadowboxing_treads" );
  // serenity_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&buff.teachings_of_the_monastery.stack=3&buff.teachings_of_the_"
  //     "monastery.remains<1" );
  ...
  // serenity_aoe->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=buff.pressure_point.up&set_bonus.tier30_2pc" );
  // serenity_aoe->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=set_bonus.tier30_2pc" );
  // serenity_aoe->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist&buff.call_to_"
  //     "dominance.up&debuff.skyreach_exhaustion.remains>buff.call_to_dominance.remains&active_enemies<10" );
  // serenity_aoe->add_action( "faeline_stomp,if=debuff.fae_exposure_damage.remains<2" );
  // serenity_aoe->add_action(
  //     "fists_of_fury,target_if=max:debuff.keefers_skyreach.remains,if=buff.invokers_delight.up,interrupt=1" );
  ...
  // serenity_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=active_enemies<6&combo_strike&set_bonus.tier30_2pc" );
  ...
  // serenity_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=talent.shadowboxing_treads&active_enemies>=3&combo_strike" );
  ...
  // serenity_4t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=buff.pressure_point.up&!talent.bonedust_brew" );
  // serenity_4t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=buff.pressure_point.up&set_bonus.tier30_2pc" );
  // serenity_4t->add_action(
  ...
  // serenity_4t->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist&buff.call_to_"
  //     "dominance.up&debuff.skyreach_exhaustion.remains>buff.call_to_dominance.remains" );
  ...
  // serenity_4t->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist" );
  // serenity_4t->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up" );
  // serenity_4t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=buff.pressure_point.up" );
  // serenity_4t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&set_bonus.tier30_2pc" );
  ...
  // serenity_4t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=talent.shadowboxing_treads&combo_strike" );
  // serenity_4t->add_action( "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains" );
  // serenity_4t->add_action( "spinning_crane_kick,if=combo_strike" );
  ...
  //     "dominance.up&debuff.skyreach_exhaustion.remains>buff.call_to_dominance.remains" );
  // serenity_3t->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist&debuff.skyreach_"
  //     "exhaustion.remains>55" );
  // serenity_3t->add_action(
  //     "fists_of_fury,target_if=max:debuff.keefers_skyreach.remains,if=buff.invokers_delight.up,interrupt=1" );
  // serenity_3t->add_action( "fists_of_fury_cancel,target_if=max:debuff.keefers_skyreach.remains" );
  // serenity_3t->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist" );
  // serenity_3t->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up&spinning_crane_kick.max" );
  // serenity_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&set_bonus.tier30_2pc" );
  ...
  // serenity_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&buff.teachings_of_the_monastery.stack=2" );
  // serenity_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=talent.shadowboxing_treads&combo_strike" );
  ...
  // serenity_2t->add_action(
  //     "faeline_stomp,if=debuff.fae_exposure_damage.remains<2&!debuff.skyreach_exhaustion.remains<2&!debuff.skyreach_"
  //     "exhaustion.remains",
  //     "Serenity 2 Targets" );
  // serenity_2t->add_action(
  //     "tiger_palm,,target_if=min:debuff.mark_of_the_crane.remains,if=!debuff.skyreach_exhaustion.up*20&combo_strike"
  ...
  // serenity_2t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=cooldown.fists_of_fury.remains>5&talent.shadowboxing_treads&buff.teachings_of_"
  //     "the_monastery.stack=1&combo_strike" );
  // serenity_2t->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up" );
  // serenity_2t->add_action( "spinning_crane_kick,if=combo_strike" );
  ...
  // serenity_st->add_action(
  //     "blackout_kick,if=combo_strike&buff.teachings_of_the_monastery.stack=3&buff.teachings_of_the_monastery.remains<"
  //     "1" );
  // serenity_st->add_action( "rising_sun_kick" );
  // serenity_st->add_action( "faeline_stomp,if=debuff.fae_exposure_damage.remains<2" );
  // serenity_st->add_action(
  //     "strike_of_the_windlord,if=talent.thunderfist&buff.call_to_dominance.up&debuff.skyreach_exhaustion.remains>buff."
  //     "call_to_dominance.remains" );
  ...
  // // >4 Target priority
  // default_aoe->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up&spinning_crane_kick.max",
  //                          ">4 Targets" );
  ...
  // default_aoe->add_action( "spinning_crane_kick,if=buff.bonedust_brew.up&combo_strike&spinning_crane_kick.max" );
  // default_aoe->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=buff.bonedust_brew.up&buff.pressure_point.up&set_bonus.tier30_2pc" );
  // default_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.stack=3&talent.shadowboxing_treads" );
  ...
  // default_aoe->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=talent.whirling_dragon_punch&cooldown.whirling_dragon_punch.remains<3&"
  //     "cooldown.fists_of_fury.remains>3&!buff.kicks_of_flowing_momentum.up" );
  // default_aoe->add_action(
  //     "expel_harm,if=chi=1&(!cooldown.rising_sun_kick.remains|!cooldown.strike_of_the_windlord.remains)|chi=2&!"
  //     "cooldown.fists_of_fury.remains" );
  // default_aoe->add_action(
  //     "spinning_crane_kick,target_if=min:debuff.mark_of_the_crane.remains,if=combo_strike&cooldown.fists_of_fury."
  //     "remains<5&buff.chi_energy.stack>10" );
  // default_aoe->add_action( "chi_burst,if=buff.bloodlust.up&chi<5" );
  // default_aoe->add_action( "chi_burst,if=chi<5&energy<50" );
  // default_aoe->add_action(
  //     "spinning_crane_kick,if=combo_strike&(cooldown.fists_of_fury.remains>3|chi>2)&spinning_crane_kick.max&buff."
  //     "bloodlust.up" );
  // default_aoe->add_action(
  //     "spinning_crane_kick,if=combo_strike&(cooldown.fists_of_fury.remains>3|chi>2)&spinning_crane_kick.max&buff."
  //     "invokers_delight.up" );
  // default_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=talent.shadowboxing_treads&combo_strike&set_bonus.tier30_2pc&!buff.bonedust_"
  //     "brew.up&active_enemies<15&!talent.crane_vortex" );
  // default_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=talent.shadowboxing_treads&combo_strike&set_bonus.tier30_2pc&!buff.bonedust_"
  //     "brew.up&active_enemies<8" );
  // default_aoe->add_action(
  ...
  // default_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.stack=3" );
  // default_aoe->add_action( "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains" );
  // default_aoe->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=talent.shadowboxing_treads&combo_strike&!spinning_crane_kick.max" );
  // default_aoe->add_action( "chi_burst,if=chi.max-chi>=1&active_enemies=1&raid_event.adds.in>20|chi.max-chi>=2" );

  // // 4 Target priority
  // default_4t->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up&spinning_crane_kick.max",
  //                         "4 Targets" );
  // default_4t->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist" );
  ...
  // default_4t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=!buff.bonedust_brew.up&buff.pressure_point.up&cooldown.fists_of_fury."
  //     "remains>5" );
  // default_4t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.stack=3&talent.shadowboxing_treads" );
  ...
  // default_4t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike" );

  // // 3 Target priority
  // default_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.stack=3&talent.shadowboxing_treads",
  //     "3 Targets" );
  // default_3t->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up" );
  // default_3t->add_action(
  //     "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains,if=talent.thunderfist&(cooldown.invoke_"
  //     "xuen_the_white_tiger.remains>20|fight_remains<5)" );
  ...
  // default_3t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=!buff.bonedust_brew.up&buff.pressure_point.up" );
  // default_3t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=set_bonus.tier30_2pc" );
  // default_3t->add_action(
  ...
  // default_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.stack=2" );
  // default_3t->add_action( "strike_of_the_windlord,target_if=max:debuff.keefers_skyreach.remains" );
  // default_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.up&(talent.shadowboxing_treads|cooldown.rising_"
  //     "sun_kick.remains>1)" );
  ...
  // default_3t->add_action(
  //     "spinning_crane_kick,target_if=min:debuff.mark_of_the_crane.remains,if=combo_strike&cooldown.fists_of_fury."
  //     "remains<3&buff.chi_energy.stack>15" );
  // default_3t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=cooldown.fists_of_fury.remains>4&chi>3" );
  // default_3t->add_action(
  //     "spinning_crane_kick,target_if=min:debuff.mark_of_the_crane.remains,if=combo_strike&cooldown.rising_sun_kick."
  //     "remains&cooldown.fists_of_fury.remains&chi>4&((talent.storm_earth_and_fire&!talent.bonedust_brew)|(talent."
  //     "serenity))" );
  // default_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&cooldown.fists_of_fury.remains" );
  // default_3t->add_action( "rushing_jade_wind,if=!buff.rushing_jade_wind.up" );
  // default_3t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&talent.shadowboxing_treads&!spinning_crane_kick.max" );
  // default_3t->add_action(
  //     "spinning_crane_kick,target_if=min:debuff.mark_of_the_crane.remains,if=(combo_strike&chi>5&talent.storm_earth_"
  //     "and_fire|combo_strike&chi>4&talent.serenity)" );

  // // 2 Target priority
  // default_2t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.teachings_of_the_monastery.stack=3&talent.shadowboxing_treads",
  //     "2 Targets" );
  // default_2t->add_action(
  ...
  // default_2t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=buff.kicks_of_flowing_momentum.up|buff.pressure_point.up" );
  // default_2t->add_action(
  //     "expel_harm,if=chi=1&(!cooldown.rising_sun_kick.remains|!cooldown.strike_of_the_windlord.remains)|chi=2&!"
  //     "cooldown.fists_of_fury.remains" );
  ...
  // default_2t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=buff.pressure_point.remains&chi>2&prev.rising_sun_kick" );
  // default_2t->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up" );
  ...
  // default_2t->add_action(
  //     "rising_sun_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+"
  //     "debuff.keefers_skyreach.remains*20),if=!talent.shadowboxing_treads&cooldown.fists_of_fury.remains>4&talent."
  //     "xuens_battlegear" );
  // default_2t->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&cooldown.rising_sun_kick.remains&cooldown.fists_of_fury.remains&(!"
  //     "buff.bonedust_brew.up|spinning_crane_kick.modifier<1.5)" );
  ...
  // // 1 Target priority
  // default_st->add_action( "rising_sun_kick,if=!cooldown.fists_of_fury.remains", "1 Target" );
  ...
  // default_st->add_action(
  //     "strike_of_the_windlord,if=talent.thunderfist&(cooldown.invoke_xuen_the_white_tiger.remains>20|fight_remains<"
  //     "5)" );
  // default_st->add_action(
  //     "rising_sun_kick,if=buff.kicks_of_flowing_momentum.up|buff.pressure_point.up|debuff.skyreach_exhaustion.remains>"
  //     "55" );
  ...
  // default_st->add_action( "spinning_crane_kick,if=combo_strike&buff.dance_of_chiji.up" );
  ...
  // // Fallthru
  // fallthru->add_action(
  //     "crackling_jade_lightning,if=buff.the_emperors_capacitor.stack>19&energy.time_to_max>execute_time-1&cooldown."
  //     "rising_sun_kick.remains>execute_time|buff.the_emperors_capacitor.stack>14&(cooldown.serenity.remains<5&talent."
  //     "serenity|fight_remains<5)",
  //     "Fallthru" );
  ...
  // fallthru->add_action(
  //     "blackout_kick,target_if=min:debuff.mark_of_the_crane.remains-spinning_crane_kick.max*(target.time_to_die+debuff."
  //     "keefers_skyreach.remains*20),if=combo_strike&active_enemies>=5" );
  // fallthru->add_action(
  //     "spinning_crane_kick,if=combo_strike&buff.chi_energy.stack>30-5*active_enemies&buff.storm_earth_and_fire.down&("
  //     "cooldown.rising_sun_kick.remains>2&cooldown.fists_of_fury.remains>2|cooldown.rising_sun_kick.remains<3&cooldown."
  //     "fists_of_fury.remains>3&chi>3|cooldown.rising_sun_kick.remains>3&cooldown.fists_of_fury.remains<3&chi>4|chi.max-"
  //     "chi<=1&energy.time_to_max<2)|buff.chi_energy.stack>10&fight_remains<7" );
